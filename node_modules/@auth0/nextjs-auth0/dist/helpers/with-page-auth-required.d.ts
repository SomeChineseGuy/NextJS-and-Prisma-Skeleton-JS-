 ...
 * @category Server
 */
export type PageRoute<P, Q extends ParsedUrlQuery = ParsedUrlQuery> = (cts: GetServerSidePropsContext<Q>) => Promise<GetServerSidePropsResultWithSession<P>>;
/**
 ...
 * @category Server
 */
export type WithPageAuthRequiredOptions<P extends {
    [key: string]: any;
} = {
    [key: string]: any;
...
export type WithPageAuthRequired = <P extends {
    ...
    [key: string]: any;
}, Q extends ParsedUrlQuery = ParsedUrlQuery>(opts?: WithPageAuthRequiredOptions<P, Q>) => PageRoute<P, Q>;
/**
 * @ignore
 */
