...
function handleLoginFactory(handler, nextConfig, baseConfig) {
    var _this = this;
    var login = function (req, res, options) {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (req.query.returnTo) {
                            ...
                            returnTo = (0, url_helpers_1.default)(dangerousReturnTo, safeBaseUrl);
                    ...
                    case 2:
                        e_1 = _b.sent();
                        throw new errors_1.LoginHandlerError(e_1);
    ...
    return function (reqOrOptions, res, options) {
        ...
        if (typeof reqOrOptions === 'function') {
            return function (req, res) { return login(req, res, reqOrOptions(req)); };
        }
        return function (req, res) { return login(req, res, reqOrOptions); };
    };
}
