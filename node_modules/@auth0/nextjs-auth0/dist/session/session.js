...
function fromTokenSet(tokenSet, config) {
    ...
    var storeIDToken = config.session.storeIDToken;
    return Object.assign(new Session(tslib_1.__assign({}, claims)), tslib_1.__assign({ accessToken: access_token, accessTokenScope: scope, accessTokenExpiresAt: expires_at, refreshToken: refresh_token }, (storeIDToken && { idToken: id_token })), remainder);
}
